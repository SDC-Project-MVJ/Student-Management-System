...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    do {
        ...
        $sql = "INSERT INTO students (usn, name, gender, branch, email, number, percentage, attendance_perc)" .
            "VALUES ('$usn','$name','$gender','$branch','$email','$number', '$average', '$attendance_perc')";
...
<head>
    ...
    <title>Create Student - <?php echo $_SESSION['AdminLoginId'] ?></title>
...
<body style="background-color:#082032;">
   ...
   <?php
    ...
    box-shadow:0 0 10px 0 white">
        <h2 style="font-family:Cursive ; text-align:center;">New Student</h2><br>
        <?php
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <div class="row">
                        <div class="col-sm-3">
                            <input type="number" class="form-control" name="subject1" value="<?php echo $subject1; ?>" placeholder="Maths">
                        </div>
                        <div class="col-sm-3">
                            <input type="number" class="form-control" name="subject2" value="<?php echo $subject2; ?>" placeholder="Chemistry">
                        </div>
                        <div class="col-sm-3">
                            <input type="number" class="form-control" name="subject3" value="<?php echo $subject3; ?>" placeholder="Physics">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-sm-3">
                            <input type="number" class="form-control" name="subject4" value="<?php echo $subject4; ?>" placeholder="Biology">
                        </div>
                        <div class="col-sm-3">
                            <input type="number" class="form-control" name="subject5" value="<?php echo $subject5; ?>" placeholder="Computer-science">
                        </div>
                        <div class="col-sm-3">
                            <input type="number" class="form-control" name="subject6" value="<?php echo $subject6; ?>" placeholder="Social-Studies">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-sm-3">
                            <input type="number" class="form-control" name="subject7" value="<?php echo $subject7; ?>" placeholder="Geography">
                        </div>
                        <div class="col-sm-3">
                            <input type="number" class="form-control" name="subject8" value="<?php echo $subject8; ?>" placeholder="English">
                        </div>
                    </div>
                    <br>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="number" class="form-control" name="attendance" value="<?php echo $attendance; ?>">
                    </div>
                    <div class="col-sm-4">
                        <h5> / 120 Days</h5>
                    </div>
            ...
            <div class="row mb-3">
                <div class="offset-sm-3 col-sm-3 d-grid">
                    <button type="submit" name="submit_button" value="Cancel" class="btn btn-primary">Submit</button>
                </div>
                <div class="col-sm-3 d-grid">
                    <button type="button" name="submit_button" value="Cancel" onclick="window.location.href='\all_students.php'" class="btn btn-outline-primary">Cancel</button>
                </div>
            </div><br>
        </form>
    </div>
